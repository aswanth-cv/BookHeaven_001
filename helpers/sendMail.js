...
const sendOtpEmail = async (email, name, otp, subject, purpose = "signup") => {
  ...
  const generateEmailTemplate = (name, otp, purpose) => {
    ...
    switch (purpose) {
      case "resend":
        ...
        message = "Here's your new verification code for your BookHaven account:";
        actionText = "Complete your signup to start exploring our amazing collection of books!";
        break;
      case "forgot-password":
        title = "Password Reset Code";
        message = "Use this verification code to reset your BookHaven password:";
      ...
      default:
        ...
        message = "Thank you for joining BookHaven. Use this verification code to complete your account setup:";
        ...
        <div class="email-container">
            ...
            <div class="footer">
                <div class="footer-text">
                    Need help? Contact our support team at <strong>support@BookHaven.com</strong>
                </div>
  ...
  const mailOptions = {
    ...
    subject,
    html: htmlContent,
    text: `Hello ${name}, Your verification code for BookHaven is: ${otp}. This code will expire in 1 minute.`, // Fallback text
  };
  ...
  if (type === "confirmation") {
    ...
    <body>
        <div class="email-container">
            ...
            <div class="footer">
                <div class="footer-text">
                    Need immediate assistance? Contact us at <strong>hello@BookHaven.com</strong> or call <strong>+91 1234567890</strong>
                </div>
                <div class="social-links">
                    <a href="#">About Us</a> |
                    <a href="#">Privacy Policy</a> |
    ...
    const adminMailOptions = {
      from: '"BookHaven Contact Form" <noreply@BookHaven.com>',
